angular.module("w11kcal.app").factory("CalenderBuildService", /*ngInject*/  function () {
...
angular.module("w11kcal.app").factory("emptyService", /*ngInject*/  function (dataService, $scope, $stateParams,$state, changeDate,$location, archiveCard, Notification, $rootScope) {
